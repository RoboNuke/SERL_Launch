...
flags.DEFINE_string("env", "Bravo7Base-v0", "Name of environment.")
...
def actor(agent: SACAgent, data_store, env, sampling_rng):
    ...
    #eval_env = gym.make(FLAGS.env, kwargs="eval")
...
def main(_):
    ...
    #print("THIS IS THE INPUTED ENV:", FLAGS.env)
    if FLAGS.render:
    ...
    def create_replay_buffer_and_wandb_logger():
        ...
        #    debug=FLAGS.debug,
        #)
        return replay_buffer, None #wandb_logger
